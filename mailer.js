    ...
    return `
        <tr>
            <td style="text-align: center; font-size: 17px; line-height: 24px; color: #000000;">
                <p style="margin: 0 0 0px; color: #000000; font-family: 'Rubik', sans-serif; font-weight: 500; padding: 40px 50px 0px 50px;">Enter the below OTP in your login screen. Note that the link expires in ${codeLifetime} minutes.</p>
            </td>
        </tr>
        <tr>
...
function getURLLinkBody(appName, codeLifetime, urlWithLinkCode) {
    return `
        <tr>
            <td style="text-align: center; font-size: 17px; line-height: 24px; color: #000000;">
                <p style="margin: 0 0 0px; color: #000000; font-family: 'Rubik', sans-serif; font-weight: 500; padding: 40px 50px 40px 50px;">Please click the button below to sign-in/up to ${appName}. Note that the link expires in ${codeLifetime} minutes.</p>
            </td>
        </tr>
        <tr>
            <td style="padding: 0 20px 10px;">
