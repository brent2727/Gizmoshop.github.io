                    ...
                    <div class='collapse navbar-collapse' id='myNavbar'>
                        ...
                        <ul class='nav navbar-nav navbar-right'>
                            ...
                            if (isset($_SESSION['uname'])) {
                                echo "<a href='pass.php'><span class='glyphicon glyphicon-user'></span>" . htmlspecialchars($_SESSION['uname']) . "</a></li>
        ...
        <center>
            <div class='container'>
                <div class='jumbotron'>
                    ...
                    <p id='p1'>Your response has been saved</p>
                </div>
            </div>
        </center>";

    // Remove user's data from the session or perform other clean-up actions
    // Be cautious with SQL delete operations
    // Uncomment this if you are sure about using the DELETE operation
    // $log = "DELETE FROM your_table WHERE username = '" . mysqli_real_escape_string($link, $_SESSION['uname']) . "'";
