...
if (isset($_SESSION['login']) && $_SESSION['login'] == true) {
    ...
    $laptops = [
        ...
        [
            ...
            'lname' => 'HP Spectre',
            'image' => 'lap2.jpg',
            'description' => 'Powerful, lightweight, and stylish, featuring four operation modes with a 360-degree hinge and Windows Ink for creative.'
        ]
    ];
        ...
        <nav class='navbar navbar-inverse navbar-fixed-top shrink'>
                    ...
                    <div class='carousel-inner'>
                        ...
                        <div class='item'>
                            ...
                            <div class='carousel-caption'>
                                ...
                                <p class='animated flipInY'>Powerful, lightweight, and stylish, featuring four operation modes with a 360-degree hinge and Windows Ink for creative.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class='periscope'>
                <div class='container-fluid'>
                    ...
                    // Display hardcoded laptops
                    foreach ($laptops as $laptop) {
                        echo "<div class='col-lg-4 col-sm-6'>";
                        echo "<div class='thumbnail'>";
                        echo "<img src='{$laptop['image']}' alt='{$laptop['lname']}'>";
                        echo "<div class='caption'>";
                        echo "<h4>{$laptop['lname']} - {$laptop['product_id']}</h4>";
                        echo "<p>{$laptop['description']}</p>";
                        echo "</div><p><a href='lapproduct.php?n1={$laptop['product_id']}' class='btn btn-primary'>More Info</a></p></div></div>";
                    }
