	...
	<body data-spy='scroll' data-target='.navbar' data-offset='50'>
		...
		<header class='v-header cont' id='home'>
			...
			<div class='header-content'>
				<h1 class="animated rubberBand">  Gizmo</h1>
			...
			<nav class='navbar navbar-inverse navbar-fixed-top shrink'>
			  	<div class='container'>
				    <div class='navbar-header'>
				      ...
				      <a class='navbar-brand' href='#home'>Gizmo</a>
				    </div>
				    <center>
				    ...
				    <div class='carousel-inner'>
				    	<div class='item active'>
				        	...
				        	<div class='carousel-caption'>
          						<h2 class="animated bounceInDown">Sony Bravia 4K TV</h2>
					    ...
					    <div class='item '>
				        	...
				        	<div class='carousel-caption'>
          						<h2 class="animated rotateInDownLeft">Apple Macbook Pro</h2>
						        <p class="animated rotateInDownLeft">The ultimate pro notebook, MacBook Pro features faster processors, upgraded memory, the Apple T2 chip, and a Retina display with True Tone technology.</p>
						    </div>
				      	</div>
				      	...
				      	<div class='item'>
				        	...
				        	<div class='carousel-caption'>
          						<h2 class="animated zoomInDown">Apple iWatch Series 4</h2>
						        <p class="animated zoomInDown">Apple Watch Series 4 features its largest display yet, a re-engineered digital crown and cellular to make calls.</p>
						    </div>
				      	</div>
				    </div>
    ...
    <div class="about-container">
        ...
        <div class="about-content">
            <div class="about-text">
                <h3>Our Story</h3>
                <p>Welcome to Gizmo, where technology meets innovation. Established in 2024, we've been at the forefront of bringing cutting-edge technology to tech enthusiasts and everyday users alike. Our journey began with a simple mission: to make the latest and greatest in technology accessible to everyone while providing unparalleled expertise and customer service.</p>
                <p>What sets us apart is our commitment to curating only the finest selection of electronics and gadgets, ensuring that every product we offer meets our stringent quality standards. Our team of tech experts thoroughly evaluates each item, so you can shop with confidence.</p>
            </div>
            ...
            <div class="about-values">
                ...
                <div class="value-item">
                    ...
                    <p>Your satisfaction is our top priority, backed by our excellent support team.</p>
                </div>
                <div class="value-item">
                    <h4>Innovation</h4>
                    <p>We constantly evolve to bring you the latest in technology and service excellence.</p>
                </div>
                <div class="value-item">
                    <h4>Integrity</h4>
                    <p>We believe in transparent business practices and honest customer relationships.</p>
                </div>
            </div>
        </div>
    </div>
